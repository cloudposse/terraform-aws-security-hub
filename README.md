...
| <a name="input_delegation_account_id"></a> [delegation\_account\_id](#input\_delegation\_account\_id) | Designate a delegated account as the Security Hub administrator | `string` | n/a | yes |
