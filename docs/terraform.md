...
|------|-------------|------|---------|:--------:|
| <a name="input_activate_organisation_auto_enable"></a> [activate\_organisation\_auto\_enable](#input\_activate\_organisation\_auto\_enable) | Activate the AWS Organization feature to automatically enable Security Hub for new accounts.<br><br>For more information, see:<br>https://docs.aws.amazon.com/securityhub/latest/userguide/accounts-orgs-auto-enable.html | `bool` | `false` | no |
